      ...
      <div className="investments">
         <div className="container">
            <div className="head py-3 px-1">
               ...
               <small>Once your deposit is confirmed, your investment starts. Kindly check <Link to={'/investments'} >investments</Link> page to see all ongoing investment</small>
            </div>
