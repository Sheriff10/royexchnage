...
export default function Staking() {
   ...
   return (
      <div className="staking position-relative">
         <div className="s-head sticky-top bg-secondary fw-bold  text-center p-3 text-light">
            <h2 className="fw-bold text-uppercase">Staking</h2>
            <span>Invest and Earn</span>
            <h1>AEDROME AIRDROP</h1>
         </div>
         ...
         {invest === true && <Invest state={state} dispatch={dispatch} toggle={toggleInvest} />}
      </div>
   );
}
